...
if (!empty($_POST)) {
    ...
    if ($validacao) {
        ...
        $sql = "UPDATE usuarios  set nome = ?, usuario = ?, senha = SHA1(?), email = ?, nivel = ?, ativo = ?, cadastro = ? WHERE id = ?";
        $q = $pdo->prepare($sql);
        $q->execute(array($nome, $usuario, $senha, $email, $nivel, $ativo, $cadastro, $id));
        Banco::desconectar();
        header("Location: index.php");
    }
} else {
        ...
        <div class="span10 offset1">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-2">
                                <div class="control-goup <?php !empty($usuarioErro) ? '$usuarioErro ' : ''; ?>">
                                    ...
                                    <div class="controls">
                                        <input  size="40" class="form-control" name="usuario" type="text"
                        ...
                        <div class="form-group col-md-5">
                                <div class="control-goup <?php !empty($senhaErro) ? '$senhaErro ' : ''; ?>">
                                    ...
                                    <div class="controls">
                                        <input size="40" class="form-control" name="senha" type="text"
                                            value="<?php echo !empty($senha) ? $senha : ''; ?>" placeholder="Insira sua senha">
                            ...
                            <div class="form-group col-md-1">
                                <div class="control-goup <?php !empty($nivelErro) ? '$nivelErro ' : ''; ?>">
                                    ...
                                    <div class="controls">
                                        <input  size="40" class="form-control" name="nivel" type="text"
                            ...
                            <div class="form-group col-md-1">
                                <div class="control-goup <?php !empty($ativoErro) ? '$ativoErro ' : ''; ?>">
                                    <label class="control-label">Ativo</label>
                                    <div class="controls">
                                        <input  size="40" class="form-control" name="ativo" type="text"
                                            value="<?php echo !empty($ativo) ? $ativo : ''; ?>">
                                        <?php if (!empty($ativoErro)) : ?>
                                        <span class="text-danger"><?php echo $ativoErrp; ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
            ...
            <input type="text" class="form-control" name="maquina['zip_code']">
                            ...
                            <div class="control-goup <?php !empty($cadastroErro) ? '$cadastroErro ' : ''; ?>">
                                    ...
                                    <div class="controls">
                                        <input  size="40" class="form-control" name="cadastro" type="text"
