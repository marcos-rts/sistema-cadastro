...
<br>
    <div class="row">
        ...
        <div class="controls">
                    <select class="form-control" name="local" placeholder="Local" value="<?php echo !empty($local) ? $local : ''; ?>">
    ...
    <div class="row">
        ...
        <div class="controls">
                    <select class="form-control" name="equip" placeholder="equipamento" value="<?php echo !empty($equip) ? $equip : ''; ?>">
                        <option value="000"></option>
